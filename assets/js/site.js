(function() {
  ...
  const PF_DATA = {
    ...
    "calc-reformas": {
      ...
      ctaKey: "openCalc",
      desc: "Estimador de custo de obra por metro quadrado ancorado no SINAPI do IBGE, com multiplicadores por profundidade da reforma, padrão de acabamento e região. Trata banheiro e cozinha como adicionais, porque não seguem a média da casa, e devolve uma faixa de valores com a divisão entre material e mão de obra, o prazo e a reserva para imprevisto que quase nenhum orçamento inclui.",
  ...
  function makeVidCard(vid) {
    ...
    if (isPlaceholder) {
      return `<div class="pf-yt" style="cursor:default">
        <div class="pf-yt-ph">
          <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false"><path fill-rule="evenodd" d="M2 5h20v14H2zM10 8.8v6.4l5.4-3.2z"/></svg>
          <span>${vid.title}</span>
  ...
  function makeClientSection(client) {
    const logo = client.logo ? `<img src="${client.logo}" alt="${client.name}" class="pf-client-logo" width="120" height="120" loading="lazy" decoding="async">` : `<span class="pf-client-logo-ph">${client.name[0]}</span>`;
  ...
  function openModal(id) {
    ...
    const stats = d.results.map(
      (r) => `<div class="pf-modal-stat"><strong>${r.v}</strong><span>${r.l}</span></div>`
    ).join("");
    ...
    const vidSec = (() => {
      if (d.clients && d.clients.length)
        return `<p class="pf-videos-label">${_t.pf.videosLabel}</p>` + d.clients.map(makeClientSection).join("");
    ...
    pmBody.innerHTML = `
      ...
      ${d.url ? `<a href="${d.url}" class="pf-modal-cta-sec" target="_blank" rel="noopener noreferrer">
        ...
        <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false"><path d="M8 5h11v11h-2.6V9.4l-9.6 9.6L5 17.2l9.6-9.6H8z"/></svg>
      </a>` : ""}
  ...
  pfModal.addEventListener("click", (e) => {
    if (e.target === pfModal) closeModal();
  });
    ...
    pt: {
      ...
      calc: {
        ...
        cards: [
          ...
          { title: "BTU para ar-condicionado", p: "Dimensione a capacidade certa para o ambiente considerando metragem, sol, pessoas e aparelhos. Mostra também o custo mensal na conta de luz." },
      ...
      faq: {
        ...
        h2: "Perguntas que todo<br>cliente faz",
        items: [
          {
      ...
      cta: {
        ...
        h2: "Vamos conversar sobre<br>o seu projeto",
    ...
    en: {
      ...
      srv: {
        ...
        cards: [
          ...
          { title: "Digital Consulting", desc: "Don't know where to start or which technology to choose? We map your current situation and deliver a clear action plan, with priorities and tool recommendations. Straight to the point." }
        ]
      },
      pf: {
        tag: "Our work",
      ...
      calc: {
        ...
        cards: [
          ...
          { title: "Air conditioning BTU", p: "Size the right capacity for the room based on area, sun exposure, people and appliances. It also shows the monthly running cost." },
      ...
      faq: {
        tag: "FAQ",
        h2: "Questions every<br>client asks",
        items: [
          {
      ...
      cta: {
        tag: "Ready to start?",
        h2: "Let's talk about<br>your project",
    ...
    es: {
      ...
      srv: {
        ...
        cards: [
          ...
          { title: "Consultoría Digital", desc: "¿No sabes por dónde empezar o qué tecnología elegir? Mapeamos tu situación actual y entregamos un plan de acción claro, con prioridades y recomendaciones de herramientas. Directo al grano." }
        ]
      },
      pf: {
        tag: "Nuestro trabajo",
      ...
      calc: {
        ...
        cards: [
          ...
          { title: "BTU para aire acondicionado", p: "Dimensiona la capacidad correcta según metraje, sol, personas y equipos. También muestra el costo mensual de energía." },
      ...
      faq: {
        ...
        h2: "Preguntas que todo<br>cliente hace",
        items: [
          {
      ...
      cta: {
        ...
        h2: "Hablemos sobre<br>tu proyecto",
  ...
  const PF_MODAL_LANG = {
    en: {
      imoveis: {
        badge: "Video Editing",
        title: "Real Estate Market Videos",
      ...
      canal: {
        badge: "Video Editing",
        title: "Gaming Channel on YouTube",
      ...
      moda: {
        badge: "E-commerce",
        title: "Footwear Store on Nuvemshop",
      ...
      suplementos: {
        badge: "E-commerce",
        title: "Flower Shop on Nuvemshop",
        desc: "Flower shop built from scratch on Nuvemshop: payment methods, shipping, plugins, product registration, client tutorials, banners and full customisation. SEO and GEO run through the whole job, from file names and alt attributes to every product description.",
        results: [{ v: "3", l: "Custom plugins" }, { v: "15 business days", l: "Average delivery time" }, { v: "100%", l: "SEO & GEO focused" }]
      },
      "calc-trabalhista": {
        badge: "SaaS",
        title: "Labor Law Calculation Platform",
    ...
    es: {
      imoveis: {
        ...
        title: "Videos para Mercado Inmobiliario",
      ...
      canal: {
        badge: "Edición de Video",
        title: "Canal de Gaming en YouTube",
      ...
      moda: {
        badge: "E-commerce",
        title: "Tienda de Calzado en Nuvemshop",
      ...
      advocacia: {
        badge: "Sitio",
        title: "Sitio para Estudio de Abogados",
      ...
      lifestyle: {
        badge: "Edición de Video",
        title: "Canal de Drone en YouTube",
      ...
      suplementos: {
        badge: "E-commerce",
        title: "Floristería en Nuvemshop",
      ...
      "calc-trabalhista": {
        badge: "SaaS",
        title: "Plataforma de Cálculo Laboral",
      ...
      "calc-climatizacao": {
        badge: "SaaS",
        title: "Plataforma de Dimensionamiento de Climatización",
  ...
  function pintarCapasReais() {
    document.querySelectorAll(".pf-card").forEach((card) => {
      ...
      if (fontes.length && !thumb.querySelector(".pf-shot")) {
        ...
        img.addEventListener("load", () => ilustra.forEach((x) => {
          x.style.display = "none";
        }));
        img.addEventListener("error", () => {
          etapa++;
          if (etapa < fontes.length) {
            img.src = fontes[etapa];
            return;
          }
          ilustra.forEach((x) => {
            x.style.display = "";
  ...
  const SRV_ICO = {
    video: '<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false"><path fill-rule="evenodd" d="M2 5h20v14H2zM10 8.8v6.4l5.4-3.2z"/></svg>',
    loja: '<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false"><path d="M4.5 8.6h15l-1.2 12.4H5.7zM7.9 8V6.9a4.1 4.1 0 0 1 8.2 0V8h-2.2V6.9a1.9 1.9 0 0 0-3.8 0V8z"/></svg>',
    saas: '<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false"><path d="M12 2l10 5-10 5L2 7zM4.3 10.9l7.7 3.9 7.7-3.9L22 12l-10 5-10-5zM4.3 15.9l7.7 3.9 7.7-3.9L22 17l-10 5-10-5z"/></svg>',
    bussola: '<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false"><path fill-rule="evenodd" d="M12 2a10 10 0 1 1 0 20 10 10 0 0 1 0-20zm4.6 5.4-6.3 2.9-2.9 6.3 6.3-2.9z"/></svg>',
    site: '<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false"><path fill-rule="evenodd" d="M2 4h20v16H2zM4 9.2V18h16V9.2zM4.6 5.9h1.7v1.7H4.6zM7.5 5.9h1.7v1.7H7.5z"/></svg>'
  };
  const SRV_STATIC = [
    {
      svg: SRV_ICO.site,
  ...
  let _srvIdx = 0;
  let _srvT = null;
  function moverSublinhado(animar) {
    const tabsEl = document.getElementById("srvTabs");
    const ind = tabsEl && tabsEl.querySelector(".srv-ind");
    const ativa = tabsEl && tabsEl.querySelector(".srv-tab.active");
    if (!ind || !ativa) return;
    ind.classList.toggle("sem-anim", !animar);
  ...
  function buildSrvTabs(t) {
    ...
    const tabsEl = document.getElementById("srvTabs");
    if (!tabsEl) return;
    tabsEl.innerHTML = (t.srv.tabs || []).map(
      (label, i) => `<button type="button" class="srv-tab${i === _srvIdx ? " active" : ""}" role="tab"
        aria-selected="${i === _srvIdx}" data-sidx="${i}"
        >${(SRV_STATIC[i] || {}).svg || ""}<span>${label}</span></button>`
    ).join("") + '<span class="srv-ind" aria-hidden="true"></span>';
    tabsEl.querySelectorAll(".srv-tab").forEach((b) => {
      b.addEventListener("click", () => {
        if (+b.dataset.sidx === _srvIdx) return;
        _srvIdx = +b.dataset.sidx;
        showSrvSlide(true);
        if (b.scrollIntoView) b.scrollIntoView({ block: "nearest", inline: "nearest", behavior: "smooth" });
      });
    });
    showSrvSlide(false);
    requestAnimationFrame(() => moverSublinhado(false));
  }
  function showSrvSlide(animar) {
    const t = _srvT;
    if (!t) return;
    const idx = _srvIdx;
    ...
    if (panelEl) {
      panelEl.innerHTML = `
        <div class="srv-panel-card${animar ? " animate-in" : ""}">
          <div class="srv-panel-top">
            <div class="srv-panel-ico">${st.svg || ""}</div>
    ...
    moverSublinhado(animar);
  }
  window.addEventListener("resize", () => moverSublinhado(false));
  if (document.fonts && document.fonts.ready) document.fonts.ready.then(() => moverSublinhado(false));
  (function() {
    ...
    let dark = true;
    try {
      dark = localStorage.getItem("mapa_theme") !== "light";
    } catch (e) {
    }
    const LABEL = {
    ...
    function labelTheme() {
      if (!btn) return;
      const l = LABEL[window._mapLang] || LABEL.pt;
      const txt = dark ? l.toLight : l.toDark;
    ...
    function applyTheme(isDark) {
      ...
      if (meta) meta.setAttribute("content", isDark ? "#0f1115" : "#f5f6f8");
      labelTheme();
      try {
        localStorage.setItem("mapa_theme", isDark ? "dark" : "light");
      } catch (e) {
      }
    }
    window._mapThemeLabel = labelTheme;
    applyTheme(dark);
  ...
  function setLang(lang) {
    ...
    try {
      localStorage.setItem("mapa_lang", lang);
    } catch (e) {
    }
    ...
    const rot = (el, txt) => {
      if (!el) return;
      const b = el.querySelector(".bl");
      if (b) b.textContent = txt;
      else el.textContent = txt;
    };
    rot(heroBtns[0], t.hero.btn1);
    ...
    rot(ctaBtns[0], t.cta.btn1);
    rot(ctaBtns[1], t.cta.btn2);
  ...
  (function initLang() {
    let saved;
    try {
      saved = localStorage.getItem("mapa_lang");
    } catch (e) {
    }
